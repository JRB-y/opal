    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr v-for="data in tableData" :key="data.id" class="m-datatable__row" v-else>
          ...
          <td>
            <img
              src="https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fsharpsnippets.files.wordpress.com%2F2013%2F12%2Feditsvg.png&f=1"
              class="edit-icon"
            />
            <img
              src="https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn1.iconfinder.com%2Fdata%2Ficons%2Fflat-web-browser%2F100%2Fremove-button-512.png&f=1"
              class="delete-icon"
            />
          </td>
